          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <Multiselect id="clinic_id" v-model="clinic_id" :value="clinic_id" placeholder="Select clinic Center"
                  v-bind="singleSelectOption" :options="clinic_centers.options" class="form-group">
                </Multiselect>
